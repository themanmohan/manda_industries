...
const Contact = () => {
  ...
  return (
      <section className="mb-14">
        ...
        <div className="max-container xl:flex md:block w-full gap-10 whitespace" data-aos="fade-left">
          ...
          <div className="xl:w-1/2 md:w-full xl:mt-0 mt-5 bg-lightBlue p-5 md:p-10 rounded-md" data-aos="fade-right">
